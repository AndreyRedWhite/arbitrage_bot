...
PAIRS = [
    ...
    ('MANAUSDT', 'MANAUSDC'), ('MNTUSDT', 'MNTUSDC'),
    ('OPUSDT', 'OPUSDC'), ('SANDUSDT', 'SANDUSDC'), ('SEIUSDT', 'SEIUSDC'),
    ('STRKUSDT', 'STRKUSDC'), ('TRXUSDT', 'TRXUSDC'),
    ('USDEUSDT', 'USDEUSDC'), ('WLDUSDT', 'WLDUSDC'), ('XLMUSDT', 'XLMUSDC'),
    ('XRPUSDT', 'XRPUSDC'), ('ZKUSDT', 'ZKUSDC'), ('ZROUSDT', 'ZROUSDC'),
